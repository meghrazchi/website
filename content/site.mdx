...
export const highlights = [
  {
    ...
    repositoryUrl: "https://github.com/meghrazchi/rudix",
    featured: true,
  },
  {
    method: "GET",
...
export const timeline = [
  {
    ...
    bullets: [
      "Owned and delivered AI-powered full-stack features end to end, from product concept to production release.",
      "Designed and integrated LLM-powered applications using RAG, embeddings, prompt engineering, and AI APIs.",
      "Built reliable production AI workflows focused on LLM response quality, latency optimization, and failure handling, and system reliability.",
...
export const heroContent = {
  ...
  description:
    "Specializing in scalable backend systems, high-performance microservices, and cloud-native architecture, with a focus on building reliable, maintainable solutions for complex technical requirements. Experienced in production AI engineering, including LLM integration, RAG pipelines, Agentic AI, MCP-based workflows, prompt engineering, and AI-powered automation."
};
