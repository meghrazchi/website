...
export const timeline = [
  {
    ...
    bullets: [
      "Owned and delivered AI-powered full-stack features end to end, from product concept and technical design to production release.",
      "Designed and integrated LLM-powered applications using RAG, embeddings, prompt engineering, structured outputs, and AI APIs.",
      "Built reliable production AI workflows focused on LLM response quality, latency optimization, failure handling, and system reliability.",
